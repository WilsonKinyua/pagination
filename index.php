<?php
$connect = mysqli_connect("localhost", "root", "", "users_test");
...
<body>
            ...
            <table class="table table-bordered">
                ...
                ?>
                    <tr>
                        ...
                        <td><input type="button" class="btn btn-info btn-xs view_data" id="<?php echo $row['id']; ?>" name="view" value="view"></td>
                    </tr>
                <?php
                }
                ?>
    ...
    <!-- Modal insert into the database -->
    ...
    <script>
        $(document).ready(function() {
            ...
            //  View data from the database using a modal
